...
export class ReservationsPage {
    ...
    createNewRegistration({ trackingNumber, locationName, sizeName }) {
        // Form
        // Mode:
        ...
        // Username:
        cy.get(selectors.reservations.addNewReservationForm.usernameInput).type('JM', { force: true });

        // Phone number:
        cy.get(selectors.reservations.addNewReservationForm.phoneNumberInput).type('50683530547', { force: true });
